        ...
        <div class="max-w-3xl mx-auto px-6">
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600">
                    Update the category name and keep your taxonomy clean.
                </p>
            </div>

            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                <form action="{{ route('admin.job-categories.update', $jobCategory) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Name</label>
                        <input type="text" name="name" value="{{ old('name', $jobCategory->name) }}"
